...
const PhonePreview = ({ configuration }: PhonePreviewProps) => {
  ...
  const { caseColor, caseModel, caseMaterial, caseFinish, croppedImageUrl, id, basePrice, totalPrice } = configuration
            ...
            <div className="bg-gray-200 p-4 rounded-lg">
              <div className="flow-root text-sm">
                ...
                <div className="  flex justify-between items-center rounded-xl  mt-2">
                  ...
                  <p className="font-semibold text-gray-900">{formatPrice(totalPrice - basePrice)}</p>
                </div>
          ...
          <div className="mt-8 flex justify-end gap-96">
            {
              !isSignedIn && !user ? (
                ...
                <Button disabled={!isSignedIn || !user} onClick={() => router.push(`/catalog/${id}/phone/checkout`)}>
                  Checkout <ArrowRightIcon /> </Button>
              )
            }
