...
const CatalogSiteMap = () => {
  ...
  const steps: Step[] = [
    ...
    {
      label: "Finish",
      href: `/catalog/${params.configId}/${params.product}/finish`,
      key: 6,
    },
  ]
  ...
  return (
    ...
    >
      <Link
        ...
        className={cn(
          "cursor-pointer w-10 h-10 rounded-full flex items-center justify-center bg-gray-200 transition-all duration-300",
          isActive
            ? "bg-myColor-100 text-white"
            : isClickable
